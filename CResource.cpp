...
void CResource::_bind_methods()
{
    ...
    ClassDB::bind_method(D_METHOD("set_parent_resource", "parent_resource"), &CResource::SetParentResource);
    ClassDB::bind_method(D_METHOD("get_parent_resource"), &CResource::GetParentResource);
    ADD_PROPERTY(PropertyInfo(Variant::OBJECT, "parent resource", PROPERTY_HINT_RESOURCE_TYPE,"CResource"), "set_parent_resource", "get_parent_resource");
}
